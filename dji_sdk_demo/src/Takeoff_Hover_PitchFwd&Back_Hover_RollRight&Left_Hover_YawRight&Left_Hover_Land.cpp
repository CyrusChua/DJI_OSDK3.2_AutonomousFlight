 ...
 *
 *  TAKEOFF-->HOVER-->PITCHFORWARDS-->HOVER-->PITCHBACKWARDS-->HOVER-->ROLLRIGHT-->HOVER-->ROLLLEFT-->HOVER-->ROLLLEFT-->HOVER-->ROLLRIGHT-->HOVER-->LAND for drone
			...
			case 19:
			{
				//Automatic Throttle Up
				    ...
				    drone->virtual_rc_enable();
                                    ...
                                    cout<< "Drone finish pitching backwards..." <<endl;
